...
Sidebar.Settings = (function () {
    ...
    return {
        ...
        sendSaveDocumentBase64ToLettersTabRequest: function (r) {
            if (typeof this.sideBarSettingStore.SaveDocumentBase64ToLettersTab !== 'undefined') {
                this.sideBarSettingStore.SaveDocumentBase64ToLettersTab(JSON.stringify(r));
            }
        },
